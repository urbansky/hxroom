...
Das gibt es selten. In dem Fall: per Mail klären, was sie genau wollen. Meistens geht es ihnen um „Wer hat meine Daten?" – nicht um „Bitte gib mir ein Login". Eine transparente Klienten-Information (siehe [DSGVO-Leitfaden](/blog/online-coaching-dsgvo-leitfaden)) löst das in der Regel.
...
Ergebnis: Deine Klienten erleben das gleiche Niveau wie bei einem WhatsApp-Anruf – aber mit deinem Branding und auf deutschen Servern.
