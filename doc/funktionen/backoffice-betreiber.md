...
> **URL:** `admin.hxroom.de` · Zugang intern, nur für HxRoom-Betreiber  
...
| # | Funktion | Detail | Prio |
|---|---|---|---|
| 01 | **Sub-Domain-Übersicht** | Liste aller vergebenen `[slug].hxroom.de`-Subdomains mit zugehörigem Coach. | MVP |
